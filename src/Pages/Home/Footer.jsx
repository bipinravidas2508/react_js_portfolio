  ...
  return (
    <footer className="footer--container">
      <div className="footer--link--container">
        <div>
          <img src="./img/portfolio.png" height="60" width="60" alt="logo" />
        </div>
        ...
        <div className="footer--social--icon">
          <ul>
            ...
            <li>
              <a
                href="https://instagram.com/bipin_ravidas0007"
            ...
            <li>
              <a
                href="https://www.linkedin.com/in/bipinravidas2508/"
                className="navbar--content"
                target="_blank"
                rel="noreferrer"
              >
            ...
            <li>
              <a
                href="mailto:bipin.ravidas1020@gmail.com"
                className="navbar--content"
                target="_blank"
                rel="noreferrer"
              >
                ...
                >
                  <path
                    fill-rule="evenodd"
                    clip-rule="evenodd"
                    d="M7.33341 6.65479H26.0001C27.1047 6.65479 28.0001 7.55022 28.0001 8.65479V24.6548C28.0001 25.7594 27.1047 26.6548 26.0001 26.6548H7.33341C6.22884 26.6548 5.33341 25.7594 5.33341 24.6548V8.65479C5.33341 7.55022 6.22884 6.65479 7.33341 6.65479ZM26.0001 8.65479L16.6667 16.6548L7.33341 8.65479V10.6548L16.6667 18.6548L26.0001 10.6548V8.65479Z"
      ...
      <div className="footer--content--container">
        <p className="footer--content">Made with by Bipin</p>
        <div className="footer--social--icon">
          <ul>
            <li>
              <Link
